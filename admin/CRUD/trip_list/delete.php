...
if (isset($_POST['delete_id'])) {
    ...
    $query = "DELETE FROM `trip` WHERE `id` = '$delete_id';";
    $query .= "DELETE FROM `coupon` WHERE trip LIKE '%[$delete_id]|[%%]|[%%]%';";
...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM `coupon` WHERE trip LIKE '%[$id]|[%%]|[%%]%'";
    $result_coupon = mysqli_query($con, $query);
    if ($result_trip && $result_coupon) {
        ...
        <div class='modal-content'>
            ...
            <div class='modal-footer'>
                ...
                <button type='button' class='btn btn-danger' data-dismiss='modal'
                    onclick='trip_delete_data(<?php echo $trip['id']; ?>)'>Confirm</button>
            </div>
        </div>
        <?php
    }
